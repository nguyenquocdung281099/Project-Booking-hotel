export default function InvoiceBody(props) {
    let { id, idroom, idUser, dateStart, dateEnd, codeDiscount, totalCost,
        paymethod, number, service, createdAt, updatedAt, userName, isOpen, findRoomName, findUser, aref } = props;
    ...
    return (
        <div className="page-wrapper" ref={aref}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-lg-3 m-b-20">
                                        ...
                                        <ul className="list-unstyled invoice-payment-details">
                                            <li>
                                                <h5>Total Due: <span className="text-right">${Number.parseFloat(totalCost).toFixed(2)}</span></h5></li>
                                            <li>Method: <span>{paymethod}</span></li>
                                            <li>Discount: <span> {codeDiscount === "" || codeDiscount ===  null || typeof codeDiscount === 'undefined' ? "None" : codeDiscount}</span></li>
                                        </ul>
                                    </div>
                                </div>
