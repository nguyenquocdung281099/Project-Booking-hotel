        ...
        <tr>
            ...
            <td>
                ...
                <Tooltip placement="top" title="Check Out" color="rgb(108, 117, 125)">
                    <span style={{ cursor: !canCheckOut ? 'not-allowed' : 'pointer' }} do>
                        <button type="button" disabled={!canCheckOut} className="btn btn-secondary"
                ...
                <Tooltip placement="top" title="Cancel" color="rgb(220, 53, 69)">
                    <span style={{ cursor: !canCancel ? 'not-allowed' : 'pointer' }} >
                        <button type="button" disabled={!canCancel} className="btn btn-danger"
                            // style={{ pointerEvents: 'none' }} 
                            onClick={() => cancel(id)}
                        >
