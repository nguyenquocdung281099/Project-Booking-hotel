...
export const GET_SERVICE_SC = "GET_SERVICE_SC";
...
export const DEL_PROMO_SC = "DEL_PROMO_SC";

export const ADD_ROOM = "ADD_ROOM";
export const ADD_ROOM_SC = "ADD_ROOM_SC";
export const EDIT_ROOM = "EDIT_ROOM";
export const EDIT_ROOM_SC = "EDIT_ROOM_SC";
export const DEL_ROOM = "DEL_ROOM";
export const DEL_ROOM_SC = "DEL_ROOM_SC";

export const ADD_SERVICE = "ADD_SERVICE";
export const ADD_SERVICE_SC = "ADD_SERVICE_SC";
...
export const GET_BLANK_DATE = "GET_BLANK_DATE";
export const GET_BLANK_DATE_SC = "GET_BLANK_DATE_SC";
export const GET_BLANK_DATE_ER = "GET_BLANK_DATE_ER";

export const GET_EXTRA_SERVICE = "GET_EXTRA_SERVICE";
export const GET_EXTRA_SERVICE_SC = "GET_EXTRA_SERVICE_SC";
export const GET_EXTRA_SERVICE_ER = "GET_EXTRA_SERVICE_ER";
...
export const CREATE_COMMENT_SC = "CREATE_COMMENT_SC";
export const CREATE_COMMENT_ER = "CREATE_COMMENT_ER";
